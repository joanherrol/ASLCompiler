...
public:
  ...
  antlrcpp::Any visitProcCallNoParams(AslParser::ProcCallNoParamsContext *ctx);
  antlrcpp::Any visitProcCallParams(AslParser::ProcCallParamsContext *ctx);
  ...
  antlrcpp::Any visitUnitary(AslParser::UnitaryContext *ctx);
  antlrcpp::Any visitExprFuncParams(AslParser::ExprFuncParamsContext *ctx);
  antlrcpp::Any visitLeftArray(AslParser::LeftArrayContext *ctx);
  antlrcpp::Any visitExprArray(AslParser::ExprArrayContext *ctx);
  antlrcpp::Any visitExprFuncNoParams(AslParser::ExprFuncNoParamsContext *ctx);
  antlrcpp::Any visitReturnStmt(AslParser::ReturnStmtContext *ctx);
  antlrcpp::Any visitPars(AslParser::ParsContext *ctx);
  ...
  antlrcpp::Any visitFilterExpr(AslParser::FilterExprContext *ctx);
