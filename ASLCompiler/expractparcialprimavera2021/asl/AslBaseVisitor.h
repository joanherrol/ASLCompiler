...
public:
  ...
  virtual antlrcpp::Any visitTupleDecl(AslParser::TupleDeclContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitPackStmt(AslParser::PackStmtContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitUnpackStmt(AslParser::UnpackStmtContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitExprTuple(AslParser::ExprTupleContext *ctx) override {
    return visitChildren(ctx);
  }
