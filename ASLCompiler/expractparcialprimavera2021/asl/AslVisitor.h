...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitTupleDecl(AslParser::TupleDeclContext *context) = 0;
    ...
    virtual antlrcpp::Any visitPackStmt(AslParser::PackStmtContext *context) = 0;

    virtual antlrcpp::Any visitUnpackStmt(AslParser::UnpackStmtContext *context) = 0;
    ...
    virtual antlrcpp::Any visitExprTuple(AslParser::ExprTupleContext *context) = 0;
