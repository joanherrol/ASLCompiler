...
public:
  ...
  antlrcpp::Any visitFuncType(AslParser::FuncTypeContext *ctx);
  ...
  antlrcpp::Any visitArrayDecl(AslParser::ArrayDeclContext *ctx);
  antlrcpp::Any visitTupleDecl(AslParser::TupleDeclContext *ctx);
